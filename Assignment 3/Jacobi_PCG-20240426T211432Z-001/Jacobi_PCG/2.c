...
void jacobi_preconditioner(int N,double M[N],double A_p[N]);
...
int iteration = 1;
FILE *fp2;
fp2 = fopen("J_P_CG_Iter_vs_residue.dat","w");

//----------------------Jacobi Preconditioner-----------------------
jacobi_preconditioner(N,M,A_p);
